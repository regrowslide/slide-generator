              ...
              return (
                <div key={master.id} className="border rounded-lg overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-12 h-6 rounded-full relative transition-colors ${isSelected ? 'bg-emerald-500' : 'bg-gray-300'
                          }`}
                      >
                        <div
                          className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-transform ${isSelected ? 'translate-x-7' : 'translate-x-1'
                            }`}
                        />
                      </div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {master.subItems.map(sub => {
                          ...
                          return (
                            <label
                              key={sub.id}
                              className={`flex items-center gap-2 px-3 py-2 border rounded cursor-pointer transition-colors ${isSubSelected
            ...
            return (
              <div key={docId} className="flex flex-col items-start gap-1">
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-3 rounded-lg border-2 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-slate-500 ${isRequired
