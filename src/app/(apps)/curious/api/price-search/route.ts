        ...
        try {
          ...
          if (obj.name && typeof obj.name === 'string' && obj.name.length >= 2) {
            ...
            return {
              ...
              productUrl: obj.productUrl || obj.url ? String(obj.productUrl || obj.url) : null,
              price,
...
1. 商品名（正式名称）
2. 商品ID（あれば）
3. 商品ページURL（直接アクセスできるURL）
4. 販売価格（税込）
5. 内容量・重量（g単位で計算）
6. キロ単価（価格÷重量×1000で計算）
...
【商品ページURLのヒント】
A-Pricee: html常に「https://a-price.jp/products/XXXXXX」というURLがある。
