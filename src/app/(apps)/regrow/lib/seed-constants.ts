// ============================================================
// Regrow シード用定数・ユーティリティ
// seed-regrow.ts と seed-regrow-actions.ts で共有
// ============================================================

export const STAFF_BY_STORE: Record<string, string[]> = {
  港北店: ['青山 美咲', '白石 結衣', '桜井 あかり', '星野 さくら', '森川 花音'],
  青葉店: ['水野 愛', '朝日 優花', '月島 彩香', '春田 美月', '秋山 陽菜'],
  中央店: ['南 莉子', '北川 美羽', '東山 心春', '西村 優奈', '風間 結愛'],
}

export const STORE_COMMENTS: Record<number, Record<string, string>> = {
  1: {
...
export const CUSTOMER_VOICES: Record<number, string> = {
...
export const getMonthMultiplier = (month: number): number => {
