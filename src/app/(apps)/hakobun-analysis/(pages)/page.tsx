...
import { BarChart3, MessageSquareText, Settings, RefreshCw, Database, BookOpen, Layers } from 'lucide-react'
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <R_Stack className="justify-between items-center flex-wrap gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">生成AIによるフィードバック構造化・カテゴリ分類</p>
            </div>
            <R_Stack className="gap-3">
              <Link
                href="/hakobun-analysis/master/categories"
              ...
              <Link
                href="/hakobun-analysis/master/rules"
                className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors flex items-center gap-2"
              >
              ...
              <Link
                href="/hakobun-analysis/master/clients"
                className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors flex items-center gap-2"
              >
